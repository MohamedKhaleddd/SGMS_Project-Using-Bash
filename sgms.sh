    ...
    do
        ...
        do
            ...
            if [ ! -z "$line" ]; then
                ...
                if   [ "$grade" = "A" ] || [ "$grade" = "A+" ]; then gp=4
                elif [ "$grade" = "A-" ]; then gp=3.7
                elif [ "$grade" = "B+" ]; then gp=3.3
                elif [ "$grade" = "B"  ]; then gp=3
                elif [ "$grade" = "B-" ]; then gp=2.7
                elif [ "$grade" = "C+" ]; then gp=2.3
                elif [ "$grade" = "C"  ]; then gp=2
                elif [ "$grade" = "C-" ]; then gp=1.7
                elif [ "$grade" = "D"  ]; then gp=1
                else gp=0
                fi
